...
<html>
    ...
    <body>
        <a href="#create-asignacion" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="create-asignacion" class="content scaffold-create" role="main">
            ...
            <g:form resource="${this.asignacion}" method="POST">
                <fieldset class="form">
